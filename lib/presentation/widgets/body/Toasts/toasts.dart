...
class WelcomeToasts {
  WelcomeToasts(context) {
    showToast(
        time: 5,
        title: "Welcome to Preshly's Portfolio!",
        description: "You can contact Preshly if you need any assistance :)",
        context: context);
    showToast(
        time: 20,
        title: "Do you want to work together?",
        description:
            "Contact Preshly via What's App, He will be more than happy to work with you! :)",
        context: context);
    showToast(
        time: 40,
